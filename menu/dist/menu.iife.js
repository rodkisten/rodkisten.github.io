/* Auto-generated from menu/menu.ts. at 8/14/2026, 3:48:58 PM Do not edit directly. */
...
`;
		...
		function appendStyle(root) {
			const style = createElement(root instanceof ShadowRoot ? root.ownerDocument : root.ownerDocument, "style");
		...
		const api = {
			...
			get config() {
				return Object.freeze({
					...globalConfig,
					dependencyUrls: { ...globalConfig.dependencyUrls }
				});
			},
			get runtime() {
				return Object.freeze({
			...
			ready: globalConfig.autoLoadDependencies ? loadDependencies() : Promise.resolve({
				elements: { ...runtimeStatus.elements },
				toaster: { ...runtimeStatus.toaster },
				cipo: { ...runtimeStatus.cipo },
				broto: { ...runtimeStatus.broto }
