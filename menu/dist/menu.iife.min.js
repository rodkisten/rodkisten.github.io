...
`;function c(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function l(e){return Array.isArray(e)?e.slice():e instanceof Date?new Date(e.getTime()):c(e)?{...e}:e}function u(){return i+=1,`rod-menu-${Date.now().toString(36)}-${i.toString(36)}`}function d(t){return t.defaultView||e}function f(e){let t=e;for(;;){try{if(t.parent&&t.parent!==t&&t.parent.document){t=t.parent;continue}}catch{}return t}}function p(){let t=f(e);try{return t.document}catch{return e.document}}function m(n){let r=new Set,i=[e];try{let t=f(e);i.includes(t)||i.push(t)}catch{}for(;i.length;){let e=i.shift();if(!(!e||r.has(e))){r.add(e);try{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:!0,value:n})}catch{try{e[t]=n}catch{}}try{e.parent&&e.parent!==e&&i.push(e.parent)}catch{}try{e.top&&e.top!==e&&i.push(e.top)}catch{}try{for(let t=0;t<e.frames.length;t+=1)i.push(e.frames[t])}catch{}try{e.opener&&!e.opener.closed&&i.push(e.opener)}catch{}}}}function h(e){let t=(e instanceof ShadowRoot,e.ownerDocument).createElement(`style`);t.dataset.rodMenuStyle=`v1`,t.textContent=s,e.append(t)}function g(e,t){if(t)for(let[n,r]of Object.entries(t))r!=null&&r!==!1&&(r===!0?e.setAttribute(n,``):e.setAttribute(n,String(r)))}function _(e){let t=o.get(e)??{count:0,overflow:e.documentElement.style.overflow,paddingRight:e.documentElement.style.paddingRight};if(t.count===0){let n=d(e),r=Math.max(0,n.innerWidth-e.documentElement.clientWidth);t.overflow=e.documentElement.style.overflow,t.paddingRight=e.documentElement.style.paddingRight,e.documentElement.style.overflow=`hidden`,r>0&&(e.documentElement.style.paddingRight=`${r}px`)}t.count+=1,o.set(e,t)}function v(e){let t=o.get(e);t&&(t.count=Math.max(0,t.count-1),t.count===0&&(e.documentElement.style.overflow=t.overflow,e.documentElement.style.paddingRight=t.paddingRight,o.delete(e)))}function y(e){switch(e){case`sm`:return`440px`;case`lg`:return`760px`;case`xl`:return`960px`;case`fullscreen`:return`calc(100vw - 16px)`;default:return`640px`}}function b(e,t){let n=e??r.defaultPresentation;return n===`auto`?t.matchMedia?.(`(max-width: 720px)`).matches?`bottom-sheet`:`modal`:n}class x{id;doc;win;host;root;result;handle;context;schemaValue;valuesValue;initialValues;errorsValue={};actionLoading=new Set;loading=!1;settled=!1;destroyed=!1;resolveResult;previousFocus=null;listeners=[];fieldNodes=new Map;inputNodes=new Map;customNodes=new Map;constructor(e){this.schemaValue={...e},this.id=e.id||u(),this.doc=p(),this.win=d(this.doc),this.valuesValue=this.buildInitialValues(e),this.initialValues=this.cloneValues(this.valuesValue),this.host=this.doc.createElement(`div`),this.host.setAttribute(`data-rod-menu-host`,this.id),this.host.className=`rm-host`;let t=r.shadowRoot&&typeof this.host.attachShadow==`function`;this.root=t?this.host.attachShadow({mode:`open`}):this.host,h(this.root),this.result=new Promise(e=>{this.resolveResult=e});let n=this;this.context={get id(){return n.id},get values(){return n.valuesValue},get errors(){return n.errorsValue},get schema(){return n.schemaValue},get host(){return n.host},get root(){return n.root},get surface(){return n.handle},get(e){return n.valuesValue[e]},set(e,t){n.setValue(e,t)},setValues(e){n.setValues(e)},reset(){n.reset()},validate(){return n.validate()},close(e){n.finish(`dismiss`,e,`api`)},dismiss(e){n.finish(`dismiss`,void 0,e??`api`)},setLoading(e){n.setLoading(e)},setActionLoading(e,t){n.setActionLoading(e,t)},setFieldError(e,t){n.setFieldError(e,t)},clearErrors(){n.clearErrors()},update(e){n.update(e)}},this.handle={id:this.id,result:this.result,element:this.host,context:this.context,close:e=>this.finish(`dismiss`,e,`api`),dismiss:e=>this.finish(`dismiss`,void 0,e??`api`),update:e=>this.update(e),setValue:(e,t)=>this.setValue(e,t),setValues:e=>this.setValues(e),getValue:e=>this.valuesValue[e],validate:()=>this.validate(),setLoading:e=>this.setLoading(e),destroy:()=>this.destroy()},this.mount()}buildInitialValues(e){let t={...e.initialValues||{}},n=this.getAllFields(e);for(let e of n)e.type!==`divider`&&e.type!==`html`&&e.type!==`button`&&(Object.prototype.hasOwnProperty.call(t,e.name)||(e.value===void 0?e.defaultValue===void 0?t[e.name]=this.defaultForField(e):t[e.name]=l(e.defaultValue):t[e.name]=l(e.value)));return t}defaultForField(e){switch(e.type){case`checkbox`:case`switch`:return!1;case`multiselect`:case`checkbox-group`:return[];case`range`:return e.min??0;case`number`:return``;case`rating`:return+(e.allowZero===!1);case`file`:return[];default:return``}}cloneValues(e){let t={};for(let[n,r]of Object.entries(e))t[n]=l(r);return t}getAllFields(e=this.schemaValue){let t=e.fields?Array.from(e.fields):[],n=e.sections?.flatMap(e=>Array.from(e.fields))??[];return[...t,...n]}mount(){this.previousFocus=this.doc.activeElement,(r.mount?.(this.doc)||this.doc.body||this.doc.documentElement).append(this.host),this.render(),a.set(this.id,this.handle),this.schemaValue.scrollLock!==!1&&_(this.doc),this.bindGlobalEvents(),this.setupVisualViewport(),requestAnimationFrame(()=>{let e=this.getRootElement();e.dataset.open=`true`,this.host.setAttribute(n,`true`),this.focusInitial();try{this.schemaValue.onOpen?.(this.context)}catch(e){this.reportError(e)}})}render(){this.fieldNodes.clear(),this.inputNodes.clear(),this.customNodes.clear(),this.root.querySelector?.(`.rm-root`)?.remove();let e=this.doc.createElement(`div`);e.className=`rm-root ${this.schemaValue.className||``}`.trim(),e.dataset.open=`false`,e.dataset.loading=String(this.loading),e.dataset.presentation=b(this.schemaValue.presentation,this.win),e.dataset.side=this.schemaValue.drawerSide||`right`,e.style.setProperty(`--rm-z`,String(this.schemaValue.zIndex??r.zIndex)),e.style.setProperty(`--rm-width`,y(this.schemaValue.size));let t=this.doc.createElement(`div`);t.className=`rm-backdrop`,this.schemaValue.closeOnBackdrop!==!1&&this.schemaValue.dismissible!==!1&&t.addEventListener(`pointerdown`,e=>{e.target===t&&this.finish(`dismiss`,void 0,`backdrop`)});let n=this.doc.createElement(`section`);if(n.className=`rm-shell`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-modal`,`true`),n.setAttribute(`aria-label`,this.schemaValue.title||`Menu`),this.schemaValue.showHandle!==!1&&e.dataset.presentation===`bottom-sheet`){let e=this.doc.createElement(`div`);e.className=`rm-handle-wrap`,e.innerHTML=`<div class="rm-handle" aria-hidden="true"></div>`,n.append(e),(this.schemaValue.draggable!==!1||this.schemaValue.swipeToDismiss!==!1)&&this.bindSwipe(e,n)}n.append(this.renderHeader());let i=this.doc.createElement(`div`);i.className=`rm-global-error`,i.dataset.show=`false`,n.append(i);let a=this.doc.createElement(`div`);a.className=`rm-body`,this.schemaValue.fields?.length&&a.append(this.renderSection({fields:this.schemaValue.fields}));for(let e of this.schemaValue.sections||[])a.append(this.renderSection(e));n.append(a),this.schemaValue.actions?.length&&n.append(this.renderActions()),e.append(t,n),this.root.append(e),this.refreshDynamicState()}renderHeader(){let e=this.doc.createElement(`header`);e.className=`rm-header`;let t=this.doc.createElement(`div`);if(t.className=`rm-heading`,this.schemaValue.eyebrow){let e=this.doc.createElement(`div`);e.className=`rm-eyebrow`,e.textContent=this.schemaValue.eyebrow,t.append(e)}if(this.schemaValue.title||this.schemaValue.icon){let e=this.doc.createElement(`div`);if(e.className=`rm-title-row`,this.schemaValue.icon){let t=this.doc.createElement(`div`);t.className=`rm-icon`,t.innerHTML=this.schemaValue.icon,e.append(t)}if(this.schemaValue.title){let t=this.doc.createElement(`h2`);t.className=`rm-title`,t.textContent=this.schemaValue.title,e.append(t)}t.append(e)}if(this.schemaValue.description){let e=this.doc.createElement(`p`);e.className=`rm-description`,e.textContent=this.schemaValue.description,t.append(e)}if(e.append(t),this.schemaValue.dismissible!==!1){let t=this.doc.createElement(`button`);t.type=`button`,t.className=`rm-close`,t.setAttribute(`aria-label`,`Fechar`),t.innerHTML=`<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/></svg>`,t.addEventListener(`click`,()=>this.finish(`dismiss`,void 0,`api`)),e.append(t)}return e}renderSection(e){let t=this.doc.createElement(`section`);t.className=`rm-section`,e.id&&(t.dataset.section=e.id),e.visibleWhen&&!this.safePredicate(e.visibleWhen)&&(t.hidden=!0);let n=!!e.collapsed,r;if(e.title||e.description){let i=this.doc.createElement(`div`);i.className=`rm-section-head`;let a=()=>{let t=this.doc.createElement(`div`);if(e.title){let n=this.doc.createElement(`h3`);n.className=`rm-section-title`,n.textContent=e.title,t.append(n)}if(e.description){let n=this.doc.createElement(`p`);n.className=`rm-section-description`,n.textContent=e.description,t.append(n)}return t};if(e.collapsible){let e=this.doc.createElement(`button`);e.type=`button`,e.className=`rm-section-toggle`,e.append(a());let t=this.doc.createElement(`span`);t.textContent=n?`+`:`−`,e.append(t),e.addEventListener(`click`,()=>{n=!n,r.hidden=n,t.textContent=n?`+`:`−`}),i.append(e)}else i.append(a());t.append(i)}r=this.doc.createElement(`div`),r.className=`rm-fields`,r.hidden=n;for(let t of e.fields)r.append(this.renderField(t));return t.append(r),t}renderField(e){let t=this.doc.createElement(`div`);if(t.className=`rm-field ${e.className||``}`.trim(),t.dataset.field=e.name,t.dataset.hidden=String(!!e.hidden),this.fieldNodes.set(e.name,t),e.type===`divider`)return t.innerHTML=`<div class="rm-divider" aria-hidden="true"></div>`,t;if(e.type!==`checkbox`&&e.type!==`switch`&&e.type!==`hidden`&&e.type!==`button`&&e.type!==`html`){let n=this.doc.createElement(`div`);n.className=`rm-label-row`;let r=this.doc.createElement(`label`);if(r.className=`rm-label`,r.htmlFor=`${this.id}-${e.name}`,r.textContent=e.label||e.name,e.required){let e=this.doc.createElement(`span`);e.className=`rm-required`,e.textContent=`*`,r.append(e)}if(n.append(r),e.description){let t=this.doc.createElement(`span`);t.className=`rm-description-field`,t.textContent=e.description,n.append(t)}t.append(n)}if(t.append(this.createControl(e)),e.help){let n=this.doc.createElement(`div`);n.className=`rm-help`,n.textContent=e.help,t.append(n)}let n=this.doc.createElement(`div`);return n.className=`rm-error`,n.setAttribute(`role`,`alert`),t.append(n),t}createControl(e){let t=this.valuesValue[e.name],n=t=>{let n=this.doc.createElement(`input`);return n.id=`${this.id}-${e.name}`,n.name=e.name,n.type=t,n.className=`rm-control`,n.placeholder=e.placeholder||``,n.disabled=!!e.disabled,n.readOnly=!!e.readonly,n.required=!!e.required,n.autofocus=!!e.autoFocus,g(n,e.attributes),this.inputNodes.set(e.name,n),n};switch(e.type){case`text`:case`email`:case`password`:case`search`:case`url`:case`tel`:{let r=n(e.type);return r.value=String(t??``),e.minLength!=null&&(r.minLength=e.minLength),e.maxLength!=null&&(r.maxLength=e.maxLength),e.pattern&&(r.pattern=e.pattern),e.autocomplete&&r.setAttribute(`autocomplete`,e.autocomplete),e.inputmode&&r.setAttribute(`inputmode`,e.inputmode),e.spellcheck!=null&&(r.spellcheck=e.spellcheck),r.addEventListener(`input`,()=>this.commitField(e,r.value)),r}case`number`:{let r=n(`number`);return r.value=t===``||t==null?``:String(t),e.min!=null&&(r.min=String(e.min)),e.max!=null&&(r.max=String(e.max)),e.step!=null&&(r.step=String(e.step)),r.addEventListener(`input`,()=>this.commitField(e,r.value===``?``:r.valueAsNumber)),r}case`textarea`:{let n=this.doc.createElement(`textarea`);return n.id=`${this.id}-${e.name}`,n.name=e.name,n.className=`rm-textarea`,n.placeholder=e.placeholder||``,n.value=String(t??``),n.rows=e.rows??4,n.disabled=!!e.disabled,n.readOnly=!!e.readonly,n.required=!!e.required,n.autofocus=!!e.autoFocus,e.minLength!=null&&(n.minLength=e.minLength),e.maxLength!=null&&(n.maxLength=e.maxLength),n.style.resize=e.resize||`vertical`,g(n,e.attributes),n.addEventListener(`input`,()=>this.commitField(e,n.value)),this.inputNodes.set(e.name,n),n}case`select`:{let n=this.doc.createElement(`select`);n.id=`${this.id}-${e.name}`,n.name=e.name,n.className=`rm-select`,n.disabled=!!e.disabled;for(let t of e.options){let e=this.doc.createElement(`option`);e.value=t.value,e.textContent=t.label,e.disabled=!!t.disabled,n.append(e)}return n.value=String(t??``),n.addEventListener(`change`,()=>this.commitField(e,n.value)),this.inputNodes.set(e.name,n),n}case`multiselect`:{let n=this.doc.createElement(`div`);n.className=`rm-chipbox`;let r=new Set(Array.isArray(t)?t.map(String):[]);for(let t of e.options){let i=this.doc.createElement(`button`);i.type=`button`,i.className=`rm-chip`,i.textContent=t.label,i.disabled=!!t.disabled;let a=()=>i.dataset.selected=String(r.has(t.value));a(),i.addEventListener(`click`,()=>{r.has(t.value)?r.delete(t.value):r.add(t.value),a(),this.commitField(e,Array.from(r))}),n.append(i)}return this.inputNodes.set(e.name,n),n}case`radio`:case`checkbox-group`:{let n=this.doc.createElement(`div`);n.className=`rm-options`,n.dataset.direction=e.direction||`vertical`;let r=e.type===`checkbox-group`?new Set(Array.isArray(t)?t.map(String):[]):null;for(let i of e.options){let a=this.doc.createElement(`label`);a.className=`rm-option`;let o=this.doc.createElement(`input`);o.type=e.type===`radio`?`radio`:`checkbox`,o.name=e.type===`radio`?e.name:`${e.name}[]`,o.value=i.value,o.disabled=!!i.disabled,o.checked=e.type===`radio`?String(t??``)===i.value:r.has(i.value),o.addEventListener(`change`,()=>{e.type===`radio`?this.commitField(e,i.value):(o.checked?r.add(i.value):r.delete(i.value),this.commitField(e,Array.from(r)))});let s=this.doc.createElement(`span`);s.className=`rm-option-copy`;let c=this.doc.createElement(`span`);if(c.textContent=i.label,s.append(c),i.description){let e=this.doc.createElement(`span`);e.className=`rm-option-desc`,e.textContent=i.description,s.append(e)}a.append(o,s),n.append(a)}return this.inputNodes.set(e.name,n),n}case`checkbox`:case`switch`:{let n=this.doc.createElement(`label`);n.className=`rm-check-row`;let r=this.doc.createElement(`span`);r.className=`rm-check-label`;let i=this.doc.createElement(`span`);if(i.className=`rm-label`,i.textContent=e.label||e.name,r.append(i),e.description){let t=this.doc.createElement(`div`);t.className=`rm-description-field`,t.textContent=e.description,r.append(t)}let a=this.doc.createElement(`input`);return a.id=`${this.id}-${e.name}`,a.name=e.name,a.type=`checkbox`,a.checked=!!t,a.disabled=!!e.disabled,a.className=e.type===`switch`?`rm-switch`:`rm-native-check`,a.addEventListener(`change`,()=>this.commitField(e,a.checked)),this.inputNodes.set(e.name,a),n.append(r,a),n}case`range`:{let n=this.doc.createElement(`div`);n.className=`rm-range-wrap`;let r=this.doc.createElement(`input`);r.id=`${this.id}-${e.name}`,r.name=e.name,r.type=`range`,r.className=`rm-range`,r.min=String(e.min??0),r.max=String(e.max??100),r.step=String(e.step??1),r.value=String(t??e.min??0);let i=this.doc.createElement(`output`);return i.className=`rm-range-value`,i.textContent=r.value,r.addEventListener(`input`,()=>{i.textContent=r.value,this.commitField(e,r.valueAsNumber)}),n.append(r),e.showValue!==!1&&n.append(i),this.inputNodes.set(e.name,r),n}case`date`:case`datetime-local`:case`time`:case`month`:case`week`:{let r=n(e.type);return r.value=String(t??``),e.min&&(r.min=e.min),e.max&&(r.max=e.max),e.step!=null&&(r.step=String(e.step)),r.addEventListener(`input`,()=>this.commitField(e,r.value)),r}case`color`:{let n=this.doc.createElement(`div`);n.className=`rm-color-row`;let r=this.doc.createElement(`input`);if(r.id=`${this.id}-${e.name}`,r.name=e.name,r.type=`color`,r.className=`rm-color`,r.value=typeof t==`string`&&/^#[0-9a-f]{6}$/i.test(t)?t:`#ff7a18`,r.addEventListener(`input`,()=>this.commitField(e,r.value)),n.append(r),e.presets?.length){let t=this.doc.createElement(`div`);t.className=`rm-presets`;for(let n of e.presets){let i=this.doc.createElement(`button`);i.type=`button`,i.className=`rm-swatch`,i.style.background=n,i.setAttribute(`aria-label`,n),i.addEventListener(`click`,()=>{r.value=n,this.commitField(e,n)}),t.append(i)}n.append(t)}return this.inputNodes.set(e.name,r),n}case`file`:{let t=n(`file`);return e.accept&&(t.accept=e.accept),t.multiple=!!e.multiple,e.capture&&t.setAttribute(`capture`,e.capture),t.addEventListener(`change`,()=>this.commitField(e,Array.from(t.files||[]))),t}case`hidden`:{let r=n(`hidden`);return r.value=String(t??``),r.addEventListener(`change`,()=>this.commitField(e,r.value)),r}case`segmented`:{let t=this.doc.createElement(`div`);t.className=`rm-segmented`;for(let n of e.options){let r=this.doc.createElement(`button`);r.type=`button`,r.className=`rm-segment`,r.textContent=n.label,r.disabled=!!n.disabled,r.dataset.selected=String(String(this.valuesValue[e.name]??``)===n.value),r.addEventListener(`click`,()=>{this.commitField(e,n.value),t.querySelectorAll(`.rm-segment`).forEach(e=>e.dataset.selected=String(e===r))}),t.append(r)}return this.inputNodes.set(e.name,t),t}case`rating`:{let t=this.doc.createElement(`div`);t.className=`rm-stars`;let n=Math.max(1,e.max??5);for(let r=1;r<=n;r+=1){let n=this.doc.createElement(`button`);n.type=`button`,n.className=`rm-star`,n.textContent=`★`,n.dataset.on=String(Number(this.valuesValue[e.name]||0)>=r),n.addEventListener(`click`,()=>{let n=e.allowZero!==!1&&Number(this.valuesValue[e.name])===r?0:r;this.commitField(e,n),t.querySelectorAll(`.rm-star`).forEach((e,t)=>e.dataset.on=String(t<n))}),t.append(n)}return this.inputNodes.set(e.name,t),t}case`button`:{let t=this.doc.createElement(`button`);return t.type=`button`,t.className=`rm-field-button rm-action`,t.dataset.variant=e.variant||`secondary`,t.textContent=e.text||e.label||e.name,t.addEventListener(`click`,async()=>{try{await e.onPress?.(this.context)}catch(e){this.reportError(e)}}),t}case`html`:{let t=this.doc.createElement(`div`);return t.innerHTML=typeof e.html==`function`?e.html(this.context):e.html,t}case`custom`:{let t=this.doc.createElement(`div`);t.dataset.customField=e.name;let n=e.render(this.context,e);return typeof n==`string`?t.innerHTML=n:n&&t.append(n),this.customNodes.set(e.name,t),t}}throw Error(`Unsupported RodMenu field type: ${e.type}`)}renderActions(){let e=this.doc.createElement(`footer`);e.className=`rm-actions`;for(let t of this.schemaValue.actions||[]){let n=this.doc.createElement(`button`);if(n.type=t.role===`submit`?`submit`:`button`,n.className=`rm-action`,n.dataset.action=t.id,n.dataset.variant=t.variant||(t.role===`destructive`?`danger`:t.role===`cancel`?`secondary`:`primary`),t.icon){let e=this.doc.createElement(`span`);e.innerHTML=t.icon,n.append(e)}let r=this.doc.createElement(`span`);r.textContent=t.label,n.append(r),n.addEventListener(`click`,()=>void this.runAction(t)),e.append(n)}return e}commitField(e,t){let n=e.transform?e.transform(t,this.context):t;this.valuesValue[e.name]=n,this.setFieldError(e.name,null);try{e.onChange?.(n,this.context)}catch(e){this.reportError(e)}try{this.schemaValue.onChange?.(this.context)}catch(e){this.reportError(e)}this.refreshDynamicState()}async runAction(e){if(!(this.actionLoading.has(e.id)||this.loading)&&!(e.validate!==!1&&e.role!==`cancel`&&!await this.validate())){this.setActionLoading(e.id,!0);try{let t=e.handler?await e.handler(this.context):void 0;(e.close??[`submit`,`cancel`,`destructive`].includes(e.role||`custom`))&&this.finish(e.id,t,`action`)}catch(e){this.reportError(e)}finally{this.setActionLoading(e.id,!1)}}}safePredicate(e){try{return!!e(this.valuesValue,this.context)}catch(e){return this.reportError(e),!0}}refreshDynamicState(){for(let e of this.getAllFields()){let t=this.fieldNodes.get(e.name);if(!t)continue;let n=!e.hidden&&(!e.visibleWhen||this.safePredicate(e.visibleWhen));t.dataset.hidden=String(!n);let r=!!e.disabled||!!e.disabledWhen?.(this.valuesValue,this.context),i=this.inputNodes.get(e.name);i&&`disabled`in i&&(i.disabled=r)}for(let e of this.schemaValue.actions||[]){let t=this.root.querySelector(`.rm-action[data-action="${CSS.escape(e.id)}"]`);t&&(t.hidden=!(!e.hidden&&(!e.visibleWhen||e.visibleWhen(this.valuesValue,this.context))),t.disabled=this.loading||this.actionLoading.has(e.id)||!!e.disabled||!!e.disabledWhen?.(this.valuesValue,this.context))}}async validate(){this.clearErrors();let e=null,t=this.getAllFields();for(let n of t){if([`divider`,`html`,`button`,`hidden`].includes(n.type))continue;let t=this.fieldNodes.get(n.name);if(t?.dataset.hidden===`true`)continue;let r=this.readFieldValue(n);if(n.required&&this.isEmptyValue(r)){this.setFieldError(n.name,`Campo obrigatório.`),e||=this.inputNodes.get(n.name)||t||null;continue}if(n.validate)try{let i=await n.validate(r,this.valuesValue,this.context);i&&(this.setFieldError(n.name,i),e||=this.inputNodes.get(n.name)||t||null)}catch(r){this.setFieldError(n.name,r instanceof Error?r.message:`Valor inválido.`),e||=this.inputNodes.get(n.name)||t||null}}if(this.schemaValue.validate)try{let e=await this.schemaValue.validate(this.valuesValue,this.context);if(typeof e==`string`&&e)this.setGlobalError(e);else if(e&&typeof e==`object`)for(let[t,n]of Object.entries(e))n&&this.setFieldError(t,n)}catch(e){this.setGlobalError(e instanceof Error?e.message:`Não foi possível validar o formulário.`)}let n=Object.keys(this.errorsValue).length===0&&!this.getGlobalError();return!n&&e&&(e.scrollIntoView({behavior:`smooth`,block:`center`}),`focus`in e&&e.focus({preventScroll:!0})),n}readFieldValue(e){if(e.type===`custom`&&e.read){let t=this.customNodes.get(e.name);if(t){let n=e.read(t,this.context);return this.valuesValue[e.name]=n,n}}return this.valuesValue[e.name]}isEmptyValue(e){return e==null||e===``||Array.isArray(e)&&e.length===0||e===!1}setFieldError(e,t){let n=this.fieldNodes.get(e);if(!t){if(delete this.errorsValue[e],n){n.dataset.error=`false`;let e=n.querySelector(`.rm-error`);e&&(e.textContent=``)}return}if(this.errorsValue[e]=t,n){n.dataset.error=`true`;let e=n.querySelector(`.rm-error`);e&&(e.textContent=t)}}clearErrors(){this.errorsValue={},this.setGlobalError(``);for(let e of this.fieldNodes.values()){e.dataset.error=`false`;let t=e.querySelector(`.rm-error`);t&&(t.textContent=``)}}setGlobalError(e){let t=this.root.querySelector(`.rm-global-error`);t&&(t.textContent=e,t.dataset.show=String(!!e),e?this.errorsValue.__global=e:delete this.errorsValue.__global)}getGlobalError(){return this.errorsValue.__global||``}setValue(e,t){this.valuesValue[e]=t,this.writeValueToControl(e,t),this.refreshDynamicState();try{this.schemaValue.onChange?.(this.context)}catch(e){this.reportError(e)}}setValues(e){for(let[t,n]of Object.entries(e))this.valuesValue[t]=n,this.writeValueToControl(t,n);this.refreshDynamicState();try{this.schemaValue.onChange?.(this.context)}catch(e){this.reportError(e)}}writeValueToControl(e,t){let n=this.getAllFields().find(t=>t.name===e);if(!n)return;if(n.type===`custom`&&n.write){let r=this.customNodes.get(e);r&&n.write(r,t,this.context);return}let r=this.inputNodes.get(e);r&&(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement?r instanceof HTMLInputElement&&[`checkbox`,`radio`].includes(r.type)?r.checked=!!t:r instanceof HTMLInputElement&&r.type===`file`||(r.value=String(t??``)):(this.render(),requestAnimationFrame(()=>{let e=this.getRootElement();e.dataset.open=`true`})))}reset(){this.valuesValue=this.cloneValues(this.initialValues),this.render(),requestAnimationFrame(()=>{this.getRootElement().dataset.open=`true`})}update(e){this.schemaValue={...this.schemaValue,...e},this.render(),requestAnimationFrame(()=>{this.getRootElement().dataset.open=`true`})}setLoading(e){this.loading=e;let t=this.getRootElement();t.dataset.loading=String(e),this.refreshDynamicState()}setActionLoading(e,t){t?this.actionLoading.add(e):this.actionLoading.delete(e);let n=this.root.querySelector(`.rm-action[data-action="${CSS.escape(e)}"]`);if(!n)return;let r=n.querySelector(`.rm-spinner`);if(t&&!r){let e=this.doc.createElement(`span`);e.className=`rm-spinner`,n.prepend(e)}else!t&&r&&r.remove();this.refreshDynamicState()}bindGlobalEvents(){let e=e=>{if(!(this.destroyed||this.settled)){if(e.key===`Escape`&&this.schemaValue.dismissible!==!1&&this.schemaValue.closeOnEscape!==!1){e.preventDefault(),this.finish(`dismiss`,void 0,`escape`);return}if(e.key===`Tab`&&this.schemaValue.trapFocus!==!1&&this.handleTab(e),e.key===`Enter`&&this.schemaValue.submitOnEnter!==!1){let t=e.target;if(t?.tagName===`TEXTAREA`||t?.isContentEditable)return;let n=this.schemaValue.actions?.find(e=>e.role===`submit`);n&&(e.preventDefault(),this.runAction(n))}}};this.doc.addEventListener(`keydown`,e,!0),this.listeners.push(()=>this.doc.removeEventListener(`keydown`,e,!0))}handleTab(e){let t=this.getFocusable();if(!t.length){e.preventDefault();return}let n=t[0],r=t[t.length-1],i=this.doc.activeElement;e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}getFocusable(){return Array.from(this.root.querySelectorAll(`button:not([disabled]):not([hidden]), input:not([disabled]):not([type="hidden"]), textarea:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])`)).filter(e=>!e.hidden&&e.offsetParent!==null)}focusInitial(){(this.root.querySelector(`[autofocus]`)||this.getFocusable()[0])?.focus({preventScroll:!0})}setupVisualViewport(){let e=this.win.visualViewport;if(!e)return;let t=()=>this.getRootElement().style.setProperty(`--rm-vvh`,`${e.height}px`);t(),e.addEventListener(`resize`,t),e.addEventListener(`scroll`,t),this.listeners.push(()=>{e.removeEventListener(`resize`,t),e.removeEventListener(`scroll`,t)})}bindSwipe(e,t){let n=0,r=0,i=!1,a=-1,o=o=>{o.button===0&&(i=!0,a=o.pointerId,n=o.clientY,r=0,e.setPointerCapture?.(a),t.style.transition=`none`)},s=e=>{!i||e.pointerId!==a||(r=Math.max(0,e.clientY-n),t.style.transform=`translate3d(0, ${r}px, 0)`)},c=e=>{!i||e.pointerId!==a||(i=!1,t.style.transition=``,r>Math.min(140,t.getBoundingClientRect().height*.22)&&this.schemaValue.swipeToDismiss!==!1&&this.schemaValue.dismissible!==!1?this.finish(`dismiss`,void 0,`swipe`):t.style.transform=``)};e.addEventListener(`pointerdown`,o),e.addEventListener(`pointermove`,s),e.addEventListener(`pointerup`,c),e.addEventListener(`pointercancel`,c),this.listeners.push(()=>{e.removeEventListener(`pointerdown`,o),e.removeEventListener(`pointermove`,s),e.removeEventListener(`pointerup`,c),e.removeEventListener(`pointercancel`,c)})}finish(e,t,r){if(this.settled)return;this.settled=!0;let i={action:e,values:this.cloneValues(this.valuesValue),data:t,reason:r},a=this.getRootElement();a.dataset.open=`false`,this.host.removeAttribute(n),this.win.setTimeout(()=>{try{this.schemaValue.onClose?.(i)}catch(e){this.reportError(e)}this.resolveResult(i),this.destroy(!1)},300)}destroy(e=!0){if(!this.destroyed){this.destroyed=!0;for(let e of this.listeners.splice(0))try{e()}catch{}if(a.delete(this.id),this.schemaValue.scrollLock!==!1&&v(this.doc),this.host.remove(),this.schemaValue.restoreFocus!==!1&&this.previousFocus instanceof HTMLElement&&this.previousFocus.isConnected)try{this.previousFocus.focus({preventScroll:!0})}catch{}e&&!this.settled&&(this.settled=!0,this.resolveResult({action:`dismiss`,values:this.cloneValues(this.valuesValue),reason:`api`}))}}getRootElement(){let e=this.root.querySelector(`.rm-root`);if(!e)throw Error(`RodMenu root is not mounted.`);return e}reportError(e){try{this.schemaValue.onError?.(e,this.context)}catch{}try{r.onError?.(e)}catch{}this.schemaValue.errorMode!==`silent`&&this.setGlobalError(e instanceof Error?e.message:String(e));try{console.error(`[RodMenu]`,e)}catch{}}}let S=e[t],C={version:`1.0.0`,get config(){return Object.freeze({...r})},open(e){return new x(e).handle},async form(e){let t=e.actions||[{id:`cancel`,label:`Cancelar`,role:`cancel`,variant:`secondary`},{id:`submit`,label:`Continuar`,role:`submit`,variant:`primary`}];return C.open({...e,actions:t}).result},async confirm(e){return(await C.open({title:e.title,description:e.description,presentation:e.presentation,actions:[{id:`cancel`,label:e.cancelLabel||`Cancelar`,role:`cancel`,variant:`secondary`},{id:`confirm`,label:e.confirmLabel||`Confirmar`,role:e.danger?`destructive`:`submit`,variant:e.danger?`danger`:`primary`}]}).result).action===`confirm`},async actions(e){let t=await C.open({title:e.title,description:e.description,presentation:e.presentation,actions:[...e.items.map(e=>({id:e.value,label:e.label,icon:e.icon,variant:e.variant||`secondary`,role:`custom`,close:!0})),{id:`cancel`,label:`Cancelar`,variant:`ghost`,role:`cancel`}]}).result;return t.action===`dismiss`||t.action===`cancel`?null:t.action},configure(e){r={...r,...e}},get(e){return a.get(e)},closeAll(e=`replaced`){for(let t of Array.from(a.values()))t.dismiss(e)},noConflict(){try{e[t]=S}catch{}return C}};m(C)})(window);let n=`RodMenu`,r=[];function i(e){!e||typeof e!=`object`&&typeof e!=`function`||r.includes(e)||r.push(e)}i(globalThis);try{typeof window<`u`&&i(window)}catch{}try{typeof self<`u`&&i(self)}catch{}try{typeof unsafeWindow<`u`&&i(unsafeWindow)}catch{}try{typeof window<`u`&&i(window.parent)}catch{}try{typeof window<`u`&&i(window.top)}catch{}let a;for(let e of r)try{let t=e[n];if(t!==void 0){a=t;break}}catch{}let o=Object.keys(t).length>0,s=Object.prototype.hasOwnProperty.call(t,`default`)?void 0:Object.prototype.hasOwnProperty.call(t,n)?t[n]:o?t:a;function c(e){if(s!==void 0){try{Object.defineProperty(e,n,{value:s,configurable:!0,writable:!0});return}catch{}try{e[n]=s}catch{}}}for(let e of r)c(e);return s})();