	...
	*/
	(function installRodElements(factory) {
		...
		function create(selector = "div", propsOrChild, ...children) {
			...
			if (parsed.className) if (namespace === HTML_NAMESPACE) element.className = parsed.className;
...
//#endregion
//#region \0rod-iife-entry:/home/runner/work/rodkisten.github.io/rodkisten.github.io/elements/elements.ts
	const __hasExports = Object.keys(elements_exports).length > 0;
	const __existing = globalThis["Elements"];
	const __value = Object.prototype.hasOwnProperty.call(elements_exports, "default") ? void 0 : Object.prototype.hasOwnProperty.call(elements_exports, "Elements") ? void 0 : __hasExports ? elements_exports : __existing;
	if (__value !== void 0) {
		globalThis["Elements"] = __value;
		if (typeof window !== "undefined") window["Elements"] = __value;
	}
