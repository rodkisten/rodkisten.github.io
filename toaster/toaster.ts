...
(function installRodToaster(globalWindow: Window & typeof globalThis): void {
  ...
  function createStyles(documentRef: Document, hostMode: "shadow" | "light-dom"): HTMLStyleElement {
    ...
    style.textContent = `
      ...
      .rod-toast-stack[data-size="compact"] .rod-toast__loading-title,.rod-toast-stack[data-size="compact"] .rod-toast__confirm-title,.rod-toast-stack[data-size="compact"] .rod-toast__rich-title,.rod-toast-stack[data-size="compact"] .rod-toast__interactive-title{font-size:11px;line-height:1}
      ...
      .rod-toast__picker-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(var(--rod-picker-item-min,112px),1fr));grid-auto-rows:auto;align-content:start;align-items:start;justify-items:stretch;gap:var(--rod-picker-gap,8px);width:100%;height:100%;min-height:0;overflow-x:hidden;overflow-y:auto;padding:1px 3px 7px 1px;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:var(--rod-border-strong) transparent;-webkit-overflow-scrolling:touch;scroll-padding:8px}.rod-toast__picker-item{appearance:none;position:relative;isolation:isolate;display:block;width:100%;height:auto;min-width:0;min-height:0;aspect-ratio:var(--rod-picker-aspect-ratio,1 / 1);align-self:start;padding:0;overflow:hidden;border:1px solid var(--rod-border);border-radius:var(--rod-picker-radius,13px);outline:0;background:linear-gradient(145deg,var(--rod-overlay),transparent),var(--rod-surface-raised);color:var(--rod-text);cursor:pointer;touch-action:manipulation;content-visibility:visible;contain:none;transition:border-color 170ms,box-shadow 220ms,opacity 170ms,transform 300ms var(--rod-ease-spring)}
      ...
      @supports (-webkit-touch-callout:none){.rod-toast__picker-grid{grid-auto-flow:row}.rod-toast__picker-item{transform:none!important;contain:none!important;content-visibility:visible!important}.rod-toast__picker-media{transform:translateZ(0)}}
